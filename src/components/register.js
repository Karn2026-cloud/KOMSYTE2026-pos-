        ...
        <div className="form-section">
          ...
          <div className="tools-section">
            <button
              ...
              className={isScanning ? 'stop-scan' : ''}
            >
              {isScanning ? "🛑 Stop Scanner" : "📷 Scan Barcode"}
            </button>
            <div
              id="reader"
              style={{ display: isScanning ? 'block' : 'none', marginTop: '10px' }}
            ></div>
          </div>
          ...
          >
            <div className="excel-upload">
              <label htmlFor="excelFile">
                {isUpdateMode ? "Update Stock via Excel" : "Add Products via Excel"}:
              </label>
              <input
                id="excelFile"
                type="file"
